/** biome-ignore-all lint/suspicious/noTsIgnore: <ignore type check on Slot.root and div props> */
...
function SidebarProvider({
	...
	const setOpen = React.useCallback(
		(value: boolean | ((value: boolean) => boolean)) => {
			...
			// biome-ignore lint/suspicious/noDocumentCookie: <Sidebar can change directly cookies>
