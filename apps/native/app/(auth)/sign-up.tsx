			...
			>
				<View className='flex-1 px-6'>
					...
					<View className='mt-16 mb-8'>
						<themedText.ThemedText className='mb-1 font-bold text-3xl text-foreground tracking-tight'>Create account</themedText.ThemedText>
						<themedText.ThemedText className='text-muted-foreground text-sm'>Start your journey today</themedText.ThemedText>
					</View>
					...
					<View className='gap-5'>
						...
						{/* Confirm Password */}
						<View className='gap-1.5'>
							<Text className='font-medium text-foreground text-sm'>Confirm password</Text>
							<Controller
								control={control}
							...
							/>
							{errors.confirmPassword && <Text className='text-destructive text-xs'>{errors.confirmPassword.message}</Text>}
						</View>

						{/* Terms */}
						<Text className='-mt-1 text-muted-foreground text-xs leading-5'>
							By creating an account you agree to our <Text className='font-medium text-primary'>Terms of Service</Text> and{' '}
						...
						<Pressable className='mt-1 items-center rounded-xl bg-primary py-4 active:opacity-80' onPress={handleSubmit(onSubmit)}>
							<Text className='font-semibold text-base text-primary-foreground'>Create account</Text>
						</Pressable>
					</View>
					...
					<View className='mt-5 flex-row items-center justify-center pb-10'>
						...
						<Pressable className='active:opacity-70' onPress={() => router.replace('/sign-in')}>
